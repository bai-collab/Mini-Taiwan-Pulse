...
import type { Map as MapboxMap, LineLayerSpecification, ExpressionSpecification } from "maplibre-gl";
...
function railwayLineLayer(opacity: number): LineLayerSpecification {
  return {
    id: LINE_LAYER_ID,
    type: "line",
    source: SOURCE_ID,
