...
export const LAYER_MANIFEST = {
  ...
  contour25k: {
    ...
    source: {
      ...
      url: "./geo/chiayi_contour_25k.geojson",
    },
    legend: null,
    popup: "contour25k",
    params: { count: 2, kinds: ["slider", "slider"] },
  ...
  contourDtm20: {
    ...
    source: {
      ...
      url: "./geo/chiayi_contour_dtm20.geojson",
    },
    legend: null,
    popup: "contourDtm20",
    params: { count: 2, kinds: ["slider", "slider"] },
  ...
  weatherStations: {
    ...
    source: {
      ...
      url: "./geo/chiayi_weather_stations_cwa.geojson",
    },
    legend: null,
    popup: "weatherStation",
    params: { count: 2, kinds: ["slider", "slider"] },
    description: "中央氣象署嘉義地面氣象測站點位（免key，僅位置無即時觀測）",
    topics: ["環境", "氣象", "測站"],
  },
    ...
    source: [
      {
        ...
        url: "./geo/chiayi_reservoirs_wra.geojson",
      },
      {
        kind: "geojson",
        sourceId: "water-reservoir-dams",
        url: "./geo/chiayi_dams_wra.geojson",
      },
    ],
    legend: null,
  ...
  waterBasins: {
    ...
    source: {
      ...
      url: "./geo/chiayi_basins_wra.geojson",
    },
    legend: null,
  ...
  // ⚠️ 同 key 2 config（拍板②）：河川面在前、河川中心線在後，順序＝OVERLAY_REGISTRY 出現序。
  //    2026-09 改接 OSM Overpass 免key geojson（原 pmtiles 本機缺檔）。
  waterRivers: {
    key: "waterRivers",
    section: { theme: "水資源 Water", group: "面 / 線" },
    label: "河川 River",
    ...
    source: [
      {
        ...
        url: "./geo/osm_chiayi_river_polygons.geojson",
      },
      {
        kind: "geojson",
        sourceId: "water-rivers",
        url: "./geo/osm_chiayi_rivers.geojson",
      },
    ],
    legend: null,
  ...
  waterLevees: {
    ...
    source: {
      ...
      url: "./geo/osm_chiayi_levees_wra.geojson",
    },
    legend: null,
  ...
  waterCanals: {
    ...
    source: {
      ...
      url: "./geo/chiayi_canals_osm.geojson",
    },
    legend: "waterCanals",
  ...
  waterProtectionZones: {
    ...
    source: {
      ...
      url: "./geo/chiayi_protection_zones_wra.geojson",
    },
  ...
  waterDetentionBasins: {
    ...
    source: {
      ...
      url: "./geo/chiayi_detention_basins_osm.geojson",
    },
    legend: null,
  ...
  lakesPondsOsm: {
    ...
    source: {
      ...
      url: "./geo/osm_chiayi_lakes_ponds.geojson",
    },
  ...
  waterFloodExtreme: {
    ...
    source: {
      ...
      url: "./geo/chiayi_flood_650mm_24hr_wra.geojson",
    },
